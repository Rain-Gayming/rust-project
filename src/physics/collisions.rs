        ...
        for (t_transform, t_collider) in terrain_query.iter_mut() {
            if e_collider.collider_type != ColliderType::None {
                ...
                if e_transform.translation.y < t_transform.translation.y + t_collider.size_y
                    && e_transform.translation.y + e_collider.size_y > t_transform.translation.y
                    && e_transform.translation.x < t_transform.translation.x + t_collider.size_x
                    && e_transform.translation.x + e_collider.size_x > t_transform.translation.x
                {
                    // gets the difference in x and y positions
                    //let x_offset = e_transform.translation.x - t_transform.translation.x;

                    //let y_offset = e_transform.translation.y - t_transform.translaton.y;
